...
_0x3:
	.DB  0x21,0xC0,0x6,0x13,0x20,0xC
_0x4:
	.DB  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x5F
	.DB  0x0,0x0,0x0,0x7,0x0,0x7
_0x0:
...
; 0000 003F send_data(char_data[ch * 5 + i]); // Send the pixel data to the display
	...
	ADD  R30,R16
	ADC  R31,R17
	SUBI R30,LOW(-_char_data)
	SBCI R31,HIGH(-_char_data)
	LD   R26,Z
	RCALL _send_data
; 0000 0040 }
	__ADDWRN 16,17,1
...
; 0000 0069 send_command(init_cmds[i]);
	LDI  R26,LOW(_init_cmds)
	LDI  R27,HIGH(_init_cmds)
	ADD  R26,R16
	ADC  R27,R17
	LD   R26,X
	RCALL _send_command
