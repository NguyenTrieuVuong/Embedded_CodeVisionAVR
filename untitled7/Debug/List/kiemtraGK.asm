...
_0x0:
	.DB  0x47,0x69,0x61,0x20,0x74,0x72,0x69,0x20
	.DB  0x41,0x44,0x43,0x3A,0x20,0x0,0xA,0x0
	.DB  0x47,0x69,0x61,0x20,0x74,0x72,0x69,0x20
	.DB  0x64,0x69,0x65,0x6E,0x20,0x61,0x70,0x3A
	.DB  0x20,0x0,0x2E,0x0,0x20,0x76,0x6F,0x6C
	.DB  0x20,0xA,0x0,0x53,0x79,0x73,0x74,0x65
	.DB  0x6D,0x20,0x41,0x6C,0x61,0x72,0x6D,0x0
	.DB  0x41,0x6C,0x61,0x72,0x6D,0x20,0x4F,0x76
	.DB  0x65,0x72,0x0
...
; 0000 004D voltage_val = adc_value*500/1024;
	...
	__GETD1N 0x400
	RCALL __DIVD21U
	STS  _voltage_val,R30
	STS  _voltage_val+1,R31
	STS  _voltage_val+2,R22
	STS  _voltage_val+3,R23
; 0000 004E putint(voltage_val);
	LDS  R26,_voltage_val
	LDS  R27,_voltage_val+1
	RCALL _putint
; 0000 004F putstring("\n");
...
; 0000 0051 demi_part = voltage_val%100;
	...
	RCALL __MODD21U
	STS  _demi_part,R30
	STS  _demi_part+1,R31
	STS  _demi_part+2,R22
	STS  _demi_part+3,R23
...
SUBOPT_0x0:
	LDS  R26,_voltage_val
	LDS  R27,_voltage_val+1
	LDS  R24,_voltage_val+2
	LDS  R25,_voltage_val+3
	__GETD1N 0x64
	RET
