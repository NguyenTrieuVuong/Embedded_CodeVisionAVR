...
_0x0:
	...
	.DB  0x75,0x72,0x65,0x3A,0x20,0x0,0x2E,0x0
	.DB  0x43,0xA,0x0
...
; 0000 0092 temp_value = (long)(temperature*1000);
	...
	RCALL __CFD1
	STS  _temp_value,R30
	STS  _temp_value+1,R31
	STS  _temp_value+2,R22
	STS  _temp_value+3,R23
...
SUBOPT_0x2:
	LDS  R26,_temp_value
	LDS  R27,_temp_value+1
	LDS  R24,_temp_value+2
	LDS  R25,_temp_value+3
	__GETD1N 0x3E8
	RET
